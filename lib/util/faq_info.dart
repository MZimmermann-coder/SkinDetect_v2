...
final List<FAQEntry> faqInfo = [
  ...
  const FAQEntry(
    ...
    description: [
      ...
      'We have applied a privacy-by-design approach, where no personal data is stored by default. Only when you save a scan to look at it again later, data is stored. This happens completely offline and is therefore completely privacy-friendly.'
    ],
  ),
  const FAQEntry(
    id: 8,
